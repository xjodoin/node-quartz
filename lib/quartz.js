...
function create(options) {
    ...
    if (redisOptions) {
        ...
        pubsub = redis.createClient(redisOptions.port, redisOptions.host, redisOptions.options);
    }
    else {
...
// Actual listener for the expired event
    ...
    var getJob = function (jobId, callback) {
    ...
    var removeJob = function (jobId, callback) {
        client.del('quartz:jobs:' + jobId, callback);
    };

    var listJobsKey = function (callback) {
